    ...
    return (
      <button
        className={cn(
          ...
          // Variants
          {
            "bg-[#2D2A26] text-white hover:bg-[#3D3A36] shadow-sm hover:shadow-md": variant === "default",
            "bg-secondary text-secondary-foreground hover:bg-secondary/80": variant === "secondary",
            "hover:bg-accent hover:text-accent-foreground": variant === "ghost",
            "border border-border-light bg-transparent hover:bg-accent hover:text-accent-foreground": variant === "outline",
            "bg-destructive text-white hover:bg-destructive/90 shadow-sm": variant === "destructive",
          },
          // Sizes
          {
            "h-10 px-6 py-2 text-sm rounded-full": size === "default",
            "h-8 px-4 text-xs rounded-full": size === "sm",
            "h-12 px-8 py-4 text-base rounded-full": size === "lg",
